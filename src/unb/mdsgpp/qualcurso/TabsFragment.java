...
public class TabsFragment extends Fragment implements OnTabChangeListener {
	...
	private void setupTabs() {
		...
		mTabHost.addTab(mTabHost.newTabSpec(TAB_INSTITUTIONS).setIndicator("Institutions").setContent(R.id.tab_1));
		mTabHost.addTab(mTabHost.newTabSpec(TAB_COURSES).setIndicator("Courses").setContent(R.id.tab_2));
	}
